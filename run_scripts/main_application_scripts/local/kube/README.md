...
- Same Kubernetes manifests (`infra/k8s/`) work identically on local and cloud
- Database can be run in Docker Compose (`infra/docker/docker-compose.yml`) or in Kubernetes
