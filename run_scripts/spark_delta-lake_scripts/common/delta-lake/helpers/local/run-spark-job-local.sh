#!/bin/bash
# Run Spark job to create Delta table from CSV
# Supports local Spark or Docker container execution
#
# Usage: run-spark-job-local.sh <INPUT_PATH> <OUTPUT_PATH> <SPARK_PACKAGES> <EXECUTION_METHOD> <SPARK_SUBMIT_PATH>
