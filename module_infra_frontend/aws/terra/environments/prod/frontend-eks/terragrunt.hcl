# Frontend (EKS) layer for prod - S3 + CloudFront, depends on EKS (ALB DNS from Ingress/env)
include "root" {
...
# alb_dns_name for EKS: set EKS_ALB_DNS_NAME env var after Ingress is created
inputs = {
