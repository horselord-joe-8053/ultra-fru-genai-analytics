...
5. **Terraform State Bucket** (for AWS deployments):
   ...
   **Important:**
   ...
   - The bucket is created automatically by deployment scripts if it doesn't exist
...
- **[`docs/README_INFRA.md`](README_INFRA.md)** - Infrastructure as Code (Terraform + Terragrunt) documentation
