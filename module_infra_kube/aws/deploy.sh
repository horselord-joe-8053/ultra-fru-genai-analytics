...
# Source helper scripts (module_infra_kube/aws/helpers and shared prepare-frontend)
...
main() {
    ...
    if manifests_dir=$(find_manifests_directory); then
        ...
        local terraform_dir="$REPO_ROOT/module_infra_kube/aws/environments/$environment/eks"
        ...
        log_info "  - module_infra_kube/shared/"
        log_info "  - k8s/"
        log_info "  - kubernetes/"
        log_info ""
