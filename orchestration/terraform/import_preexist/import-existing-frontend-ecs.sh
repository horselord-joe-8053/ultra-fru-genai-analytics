...
FRONTEND_ECS_DIR="$REPO_ROOT/module_infra_frontend/aws/terra/environments/$ENVIRONMENT/frontend-ecs"
...
import_ensure_dir_and_cd "$FRONTEND_ECS_DIR" "frontend-ecs"
import_init_soft
