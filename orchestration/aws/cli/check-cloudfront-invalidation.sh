...
#
# Example:
#   ./orchestration/aws/cli/check-cloudfront-invalidation.sh \\
...
if [ -f "$REPO_ROOT_CLI_CF/orchestration/common/logger.sh" ]; then
    source "$REPO_ROOT_CLI_CF/orchestration/common/logger.sh"
else
