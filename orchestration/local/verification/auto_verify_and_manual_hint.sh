...
REPO_ROOT="${REPO_ROOT:-$(cd "$SCRIPT_DIR/../../.." && pwd)}"  # verification -> local -> orchestration -> repo
source "$REPO_ROOT/orchestration/common/logger.sh"
source "$REPO_ROOT/orchestration/common/env/load-env.sh"
source "$REPO_ROOT/orchestration/common/verify-endpoints.sh"
...
local_manual_hint_script="$REPO_ROOT/orchestration/local/verification/manual_test_hint.sh"
