...
#     ./test/test_query_1_TOP.sh --test-env aws --stream
#     ./test/test_query_1_TOP.sh --test-env aws --use-cached-aws-val --stream
#
...
#     ./test/test_query_1_TOP.sh --test-env local --stream
#
#   Local Environment (force rebuild all images):
#     ./test/test_query_1_TOP.sh --test-env local --force-rebuild-local-img
#     ./test/test_query_1_TOP.sh --test-env local --force-rebuild-local-img --stream
#
# Notes:
