...
6. [☸️ Kubernetes / EKS Deployment (Option B)](#-5-kubernetes--eks-deployment-option-b)
   - [5.1 Backend deployment YAML (simplified)](#51-backend-deployment-yaml-simplified)
7. [🏗️ Terraform IaC (Option C – Fully Implemented)](#-6-terraform-iac-option-c--fully-implemented)
