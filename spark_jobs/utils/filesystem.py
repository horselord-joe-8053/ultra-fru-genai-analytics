...
Provides unified interface for local filesystem, S3, and EFS.
"""
...
def exists(path: str) -> bool:
    ...
    if storage_type == 's3':
        ...
        from spark_jobs.utils.s3_helpers import s3_exists
...
def listdir(path: str) -> List[str]:
    ...
    if storage_type == 's3':
        from spark_jobs.utils.s3_helpers import s3_listdir
...
def isdir(path: str) -> bool:
    ...
    if storage_type == 's3':
        ...
        from spark_jobs.utils.s3_helpers import s3_isdir
